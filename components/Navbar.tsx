...
import { Cloud, Menu, X, ShoppingCart, Globe, Activity } from 'lucide-react';
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-white/10 dark:bg-black/10 backdrop-blur-md shadow-sm">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="h-4 w-px bg-zinc-200/20 dark:border-white/10 mx-2" />
        ...
        {isOpen && (
          ...
          >
            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-emerald-500/10 text-emerald-500 text-[10px] font-bold uppercase tracking-widest border border-emerald-500/20 mb-2">
              <Activity className="w-3 h-3 animate-pulse" />
              <span>All Systems Operational</span>
            </div>
